(function($) {
    $.fn.jquizzy = function(settings) {
        var defaults = {
            ...
            sendResultsURL: null,
            resultComments: {
                perfect: 'Are you briliiant as Einstein?',
                excellent: 'Very good!',
                good: 'Well down!',
        ...
        var config = $.extend(defaults, settings); //用于将一个或多个对象的内容合并到目标对象
        ...
        answers = [],
        introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">Try to answer the quiz.Are you ready？<br/><br/><span><img src="'+config.startImg+'"></span></a></div>	',
        exitFob = '<div class="results-container slide-container"><div class="question-number">' + config.endText + '</div><div class="result-keeper"></div></div><div class="notice">Please choose one option！</div><div class="progress-keeper" ><div class="progress"></div></div>',
        contentFob = '',
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
            ...
            if (questionsIteratorIndex !== 0) {
                contentFob += '<div class="prev"><a class="nav-previous" href="#">&lt; Up</a></div>';
            }
        ...
        superContainer.find('.final').click(function() {
            ...
            resultSet = '<h2 class="qTitle">' + judgeSkills(score) + '<br/> Your score is ' + score + '</h2>' + shareButton + '<div class="jquizzy-clear"></div>' + resultSet + '<div class="jquizzy-clear"></div>';
...
function openLeft_dh() {
    $(".main-quiz-holder").css({"right":"0px","transition":"0.5s"});
}
function closeLeft_dh() {
    $(".main-quiz-holder").css({"right":"1000px","transition":"0.5s"});
}